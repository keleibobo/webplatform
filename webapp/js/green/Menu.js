...
function Menu_HoverDynamic(item, subitem) {
    $(item).mouseover(function () {
        ...
        document.getElementById(pn).style.background = "url(../images/green/line005.gif)";
    ...
    item.style.background = "#A2FFFF";
    //第三级子菜单over时，它的上级颜色加载
    if (typeof (subitem) != "undefined") eval(subitem).style.background = "#A2FFFF";
...
function Menu_HoverStatic(item, isum) {
    ...
    item.style.background = "url(../images/green/line005.gif)";
...
function Menu_Unhover(item) {
    ...
    if (lastmenu != "") {
        ...
        document.getElementById(lastmenu).style.background = "url(../images/green/line005.gif)";
