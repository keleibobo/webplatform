...
function fnShowEditDialog(id, op, st, x, y) {
    ...
    str += '<table border="0" cellspacing="0" cellpadding="0" width="100%" style=" margin-top:10px;height:78px;text-align:center;"><tr><td>值：<input id="pointValue" onkeyup="verifyVal()" type="text" style=" width:70px;" value="' + initValue + '" /></td></tr>';
