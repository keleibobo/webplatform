<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WinPOP.aspx.cs" Inherits="user_WinPOP" %>
...
*/
    CLASS_MSN_MESSAGE.prototype.show = function () {
        ...
        var fun = function () {
          ...
          try{  me.Pop.show(x, y, width, height);
          }
          catch(e){}
...
**/
    ...
    CLASS_MSN_MESSAGE.prototype.rect = function (left, right, top, bottom) {
        try {
            this.left = left != null ? left : this.right - this.width-5;
    ...
    var MSG1 = new CLASS_MSN_MESSAGE("aa", 200, 120, "消息提示：", "<%=Request["Notice"] %>", "");
